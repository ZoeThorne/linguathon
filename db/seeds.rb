...
user2 = User.create(name: "Colin", email: "colin@gmail.com", password: "password", password_confirmation: "password")

Word.create(language: "german", english: "alone", tl: "allein", topic: "me, my family and friends", word_type: "adj", tier: "foundation")
Word.create(language: "german", english: "print", tl: "drucken", topic: "technology", word_type: "verb", tier: "foundation")
Word.create(language: "german", english: "adventure film", tl: "der Abenteuerfilm", topic: "free-time activities", word_type: "noun", tier: "foundation")
...
Word.create(language: "german", english: "as if", tl: "als ob", topic: "connectives", word_type: "other", tier: "foundation")
Word.create(language: "german", english: "through", tl: "durch", topic: "prepositions", word_type: "other", tier: "foundation")
Word.create(language: "german", english: "idea", tl: "die Ahnung", topic: "opinions", word_type: "noun", tier: "foundation")